<html lang="en">
   ...
   <body>
      ...
      <!-- <script src="http://web9.vtdns.net/js/wheel_api.js"></script>  -->
...
function WheelMapping(key = '') {
    ...
    $('#car_image_0').attr('src', allData['carimage']);
    $('#image-diameter-front-0').attr('src', allData['frontimage']);
    $('#image-diameter-back-0').attr('src', allData['frontimage']);
