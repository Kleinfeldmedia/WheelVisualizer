...
<head>
    ...
    <!-- <link rel="stylesheet" href="http://localhost:8001/css/wheel-api-new6.css"> -->
    <link rel="stylesheet" href="http://web9.vtdns.net/css/wheel-api-new6.css"> 
...
<body>
    ...
    // var accesstoken= "{{@$request->accesstoken?:'Ykc5allXeG9iM04w'}}"//new6
    var accesstoken= "{{@$request->accesstoken?:'ZDJWaU5pNTJkR1J1Y3k1dVpYUT0='}}"//new6
    // Ykc5allXeG9iM04w
    // ZDJWaU5pNTJkR1J1Y3k1dVpYUT0=
    </script>

    <!-- <script src="http://localhost:8001/js/wheel-api-new6.js"></script>  -->
    <script src="http://web9.vtdns.net/js/wheel-api-new6.js"></script> 
